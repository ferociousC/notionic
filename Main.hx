  ...
  static public function main():Void {
	...
	yliy = act_2(chron, strua, yliy, q4ant);
		   ...
		   static public function act_2(mist:Int, dome:Int, ?meteo:Int, ?detsu:String){
				...
				var command_2 = ['checkout', 'development'];
				var command_2nn = ['checkout', '-b', 'development'];
				...
				var command_5 = ['remote', 'add', 'origin', 'ssh://git@github.com/ferociousC/faurious.git'];
				var command_5n = ['clone', 'ssh://git@github.com/ferociousC/faurious.git', '.'];
		...
		/*	  	clientele('git', command_m5);
				...
				temporas(meteo, detsu);
   				...
   				if (!sys.FileSystem.exists('./.git')) {
					...
					meteo = clientele('git', command_5n);
